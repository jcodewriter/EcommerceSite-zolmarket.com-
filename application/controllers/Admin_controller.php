...
class Admin_controller extends Admin_Core_Controller
{
    ...
    */
    ...
    public function send_email_subscribers_post()
    {
        ...
        if ($email_faileds != "") {
            $this->session->set_flashdata('error', trans("msg_error") . '<br/>' . $email_faileds);
        }
        redirect($this->agent->referrer());
    }
     ...
     * Ads Delete
     */
    public function delete_ad_spaces()
    {
        $id = $this->input->post('field_id', true);
        $this->ad_model->delete_ad_code($id);
        redirect($this->agent->referrer());
    }
    ...
    */
    ...
    public function shop_opening_requests()
    {
        ...
        $this->order_admin_model->show_notifications(".007.003");
