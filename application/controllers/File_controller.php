...
class File_controller extends Home_Core_Controller
{
    ...
    {
        $this->file_model->upload_avatar_image();
    }
    ...
    /**
     * Get Uploaded Avatar Session
     */
    public function get_sess_uploaded_avatar()
    {
        $file_id = $this->input->post('file_id', true);
        echo '<img src="'.get_user_avatar($this->auth_user).'" alt="">' .
            '<a href="javascript:void(0)" class="btn-img-delete btn-delete-product-img-session" data-file-id="' . $file_id . '">Select Image</a>';
    }
