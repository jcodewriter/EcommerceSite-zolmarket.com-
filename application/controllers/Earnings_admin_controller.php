...
class Earnings_admin_controller extends Admin_Core_Controller
{
    ...
    public function earnings()
    {
        ...
        $this->order_admin_model->show_notifications(".005.001");
    ...
    public function seller_balances()
    {
        ...
        $data['admin_settings'] = get_admin_settings();
        $this->order_admin_model->show_notifications(".005.002");
        //get paginated earnings
    ...
    public function completed_payouts()
    {
        ...
        $data['admin_settings'] = get_admin_settings();
        $this->order_admin_model->show_notifications(".006.002");
        //get paginated earnings
    ...
    public function payout_requests()
    {
        ...
        $this->order_admin_model->show_notifications(".006.001");
        //get paginated earnings
