...
class Product_admin_controller extends Admin_Core_Controller
{
    ...
    public function products()
    {
        ...
        $this->order_admin_model->show_notifications(".003.001");
    ...
    public function pending_products()
    {
        ...
        $this->order_admin_model->show_notifications(".003.002");
    ...
    public function hidden_products()
    {
        ...
        $this->order_admin_model->show_notifications(".003.003");
        //get paginated products
    ...
    public function sold_products()
    {
        ...
        $this->order_admin_model->show_notifications(".003.004");
        //get paginated products
    ...
    public function drafts()
    {
        ...
        $this->order_admin_model->show_notifications(".003.005");
    ...
    public function deleted_products()
    {
        ...
        $this->order_admin_model->show_notifications(".003.006");
        //get paginated products
    ...
    public function promoted_products_transactions()
    {
        ...
        $this->order_admin_model->show_notifications(".004.001");
