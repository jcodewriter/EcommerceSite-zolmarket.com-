...
class Order_admin_controller extends Admin_Core_Controller
{
    ...
    public function orders()
    {
        ...
        $this->order_admin_model->show_notifications(".001.001");
    ...
    public function transactions()
    {
        ...
        $this->order_admin_model->show_notifications(".001.002");
    ...
    public function order_bank_transfers()
    {
        ...
        $this->order_admin_model->show_notifications(".001.003");
    ...
    public function digital_sales()
    {
        ...
        $this->order_admin_model->show_notifications(".002.001");
