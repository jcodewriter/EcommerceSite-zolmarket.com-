...
?>
	<li class="nav-item text-left">
		<label onclick="
					...
					<?php endif; ?>" <?php if ($currenttype != "city_id") : ?> data-type="<?= $nexttype ?>" data-ajax="<?= $item->id ?>" data-url="custom_location" <?php endif; ?> class="nav-link p-0 <?= ($type != "city_id" && $item->cnt > 1) ? 'has-menu' : '' ?>">
			<div class="link-icon">
