...
//generate popup category url
if (!function_exists('generate_popup_category_url')) {
    function generate_popup_category_url($category)
    {
        if (!empty($category)) {
...
if (!function_exists('get_products_count_by_subcategory')) {
    function get_products_count_by_subcategory($category_id)
    {
        ...
        return get_products_count_by_category($category_id);
    }
}
    ...
    function get_location($object)
    {
        ...
        if (!empty($object)) {
            ...
            if (!empty($object->country_id)) {
                ...
                if (!empty($country) && $object->country_id != $ci->general_settings->default_product_location) {
