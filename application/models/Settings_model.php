...
class Settings_model extends CI_Model
{
    ...
    public function update_email_options()
    {
        $data = array(
            ...
            'user_send_email_new_product' => $this->input->post('user_send_email_new_product', true),
            'send_review_email' => $this->input->post('send_review_email', true),
            'send_comment_email' => $this->input->post('send_comment_email', true),
            'email_option_store_added' => $this->input->post('email_option_store_added', true),
    ...
    public function update_navigation()
    {
        $data = array(
            ...
            'choose_image_view_mobile' => $this->input->post('choose_image_view_mobile', true),
            'choose_image_view_desktop' => $this->input->post('choose_image_view_desktop', true)
        );
    ...
    */
    ...
    //get custom product conditions
    public function get_custom_product_conditions($category_id)
    {
        // $sql = 'select *from custom_fields as t0
        //     join (select t0.field_id, t2.name, t1.field_option, t0.category_id, t1.common_id from custom_fields_category as t0
        //         join custom_fields_options as t1 on t1.lang_id = '.$lang_id.' and t0.field_id = t1.field_id
        //         join custom_fields_lang as t2 on t2.lang_id = '.$lang_id.' and t0.field_id = t2.field_id
        //         where t0.category_id = '.$category_id.') as t1 on t0.id = t1.field_id';
