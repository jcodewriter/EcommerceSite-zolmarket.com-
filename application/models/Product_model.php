...
class Product_model extends Core_Model
{
                    ...
                    if (!empty($field_values)) {
                        if ($custom_field->field_type == 'checkbox') {
                            ...
                            if (!empty($field_value_id)) {
                                if ($custom_field->field_type == 'radio_button' || $custom_field->field_type == 'dropdown' || $custom_field->field_type == 'popup') {
                                    $data = array(
    ...
    //filter products
    public function filter_products($categories_id)
    {
        ...
        if (!empty($categories_id)) {
            $this->db->where_in('products.category_id', $categories_id);
    ...
    public function get_paginated_filtered_products($categories_id, $per_page, $offset)
    {
    ...
    public function get_paginated_filtered_products_count($categories_id)
    {
        $this->filter_products($categories_id);
        $query = $this->db->get('products');
