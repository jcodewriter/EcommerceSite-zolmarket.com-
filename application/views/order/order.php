...
<div class="hkm_messages_navCatDownMobile">
	<div class="cat-header">
        <div class="mobile-header-back">
            <a href="<?php echo lang_base_url().'orders';?>" class="btn-back-mobile-nav"> <i class="icon-arrow-left"></i> <?php echo trans("back"); ?>  </a>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <div class="row-custom page_title_hidden_on_mobile">
                    <!-- load profile nav -->
