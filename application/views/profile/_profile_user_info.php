...
<div class="row-custom">
    <div class="profile-details">
        <div class="leftdesktop">
            <div class="only_on_mobile" style="width: calc(100% + 30px);height: 200px;margin-bottom: 10px;margin-left: -15px;margin-top: -20px;background: url('<?php echo get_user_avatar($user); ?>');background-position: center;background-repeat: no-repeat;background-color: #282828;background-size: cover;">
            <?php 
        ...
        <div class="right" style="position: relative;" >
            ...
            <div class="row-custom user-contact" style="margin-bottom: 0;">
                ...
                <?php else: ?>
                    ...
                    <?php endif; ?>
                    <?php if (!empty(get_location($user)) && $user->show_location == 1): ?>
                        <span class="info" style="margin-bottom: -10px;"><i class="icon-map-marker" ></i><?php echo get_location($user); ?></span>
                    <?php endif; ?>
                <?php endif; ?>
