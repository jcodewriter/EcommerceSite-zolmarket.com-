                    ...
                    <td>
                        <div class="mailcontent" style="line-height: 20px;font-size: 14px;">
                            <p style='text-align: center;margin-top: 5px;margin-bottom:10px'>
                                <strong style="font-size: 20px; font-weight: 700;"><?php echo $subject;?></strong>  
                            </p>
                            <?php if (!(empty($img_src))) : ?>
                            <div style="display: flex;text-align:left;">
                                <?php if (!empty($conversation_id)):?>
                                    <a href='<?php echo lang_base_url(); ?>messages/conversation/<?php echo $conversation_id;?>' style="height: 60px; width: 80px;">
                                        <img src="<?php echo $img_src;?>" style="width:80px;height: 60px !important;border-radius: 5px;">    
                                    </a>      
                                <?php else:?>
                                    <a href='<?php echo lang_base_url(); ?>messages' style="height: 60px; width: 80px;">
                                        <img src="<?php echo $img_src;?>" style="width:80px;height: 60px !important;border-radius: 5px;">    
                                    </a>   
                                <?php endif;?>
                            ...
                            <div style="display: flex;text-align:left;margin-top: 15px;">
                                <?php if(!(empty($this->auth_user->avatar))):?>
                                    <img src="<?php echo base_url().$this->auth_user->avatar;?>" style="width:50px; height: 50px !important; border-radius: 50%">
                                <?php else:?>
                                ...
                                <div style="background-color: #eff2f5;padding: 5px 15px;margin-left: 5px;border-radius: 5px;max-width: 70%;">
                                    <?php if(is_arabic($message_sender)): ?>
                                        <span class="" style="font-size: 14px !important;font-weight: 600;display: block;width: 100%;text-overflow: ellipsis;white-space: nowrap;overflow: hidden;height:24px;"><?php echo $message_sender;?></span>
                                    <?php else: ?>
                                        <span class="" style="font-size: 14px !important;font-weight: 600;display: block;width: 100%;text-overflow: ellipsis;white-space: nowrap;overflow: hidden;height:24px;direction: rtl"><?php echo $message_sender;?></span>
                                    <?php endif; ?>
                                    <span class="" style="display: block;word-break: break-word;font-size: 12px !important;"><?php echo $message_text;?></span>        
                                </div>
                            </div>
                            <div style='text-align: center;margin-top: 40px;margin-bottom: 15px;'>
                                <?php if (!empty($conversation_id)):?>
                                    <a href='<?php echo lang_base_url(); ?>messages/conversation/<?php echo $conversation_id;?>' style="display: block;padding: 14px 0;width: 100%; max-width: 375px;font-size: 14px;text-decoration: none;background-color: #09b1ba;color: #ffffff !important; border-radius: 3px;margin: 0 auto;" target="_blank" rel="noreferrer nofollow noopener"><?php echo trans("messages"); ?></a>
                                <?php else:?>
                                    <a href='<?php echo lang_base_url(); ?>messages' style="display: block;padding: 14px 0;width: 100%; max-width: 375px;font-size: 14px;text-decoration: none;background-color: #09b1ba;color: #ffffff !important; border-radius: 3px;margin: 0 auto;" target="_blank" rel="noreferrer nofollow noopener"><?php echo trans("messages"); ?></a>
                                <?php endif;?>
                            </div>
                        </div>
                    </td>
