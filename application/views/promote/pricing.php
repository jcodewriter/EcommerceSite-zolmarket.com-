...
<div class="hkm_messages_navCatDownMobile">
	<div class="cat-header">
        ...
        <div class="mobile-header-title">
            <span  class="text-white textcat-header text-center"><?php echo trans("promote_your_product"); ?></span>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div id="content" class="col-12">
                ...
                <h1 class="page-title page-title-product page_title_hidden_on_mobile"><?php echo trans("promote_your_product"); ?></h1>
