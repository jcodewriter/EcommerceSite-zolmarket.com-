...
<div class="top-search-bar mobile-search-form">
    ...
    <div style="padding: 5px 8px;">
        <div class="clearable-parent">
            <div style="white-space: nowrap;color: #b0b3b6;font-size: 12px;font-weight: bold; background: #555">
            ...
            <div><button onclick="this.form.submit();" form="formsearchzolmarket" class="icon-search" style="color: #555"></button></div>
        </div>
    </div>
