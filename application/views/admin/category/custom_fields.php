                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($fields as $item) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="ads_result_page" style="margin-top: 5px">
                                                    ...
                                                    <?php if ($item->field_type == 'dropdown' || $item->field_type == 'popup') :
                                                        ...
                                                        <?php else : ?>
                                                            <button class="btn btn-sm btn-success"><i class="fa fa-plus"></i>&nbsp;<?php echo trans('add_from_ads_result_page'); ?></button>
                                                    <?php endif;
                                                    endif; ?>
                                                    <?php echo form_close(); ?>
                                                </div>
                                            ...
                                            <td><?php
                                                foreach ($ct_cs_fields as $ctg_item) {
                                                    if ($item->id == $ctg_item->id) {
                                                        echo str_replace('-', ' ', $ctg_item->slug) . '<br>';
                                                    }
                                                }
