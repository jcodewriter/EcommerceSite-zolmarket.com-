                                ...
                                <?php foreach ($categories as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <label class="label bg-gray label-table"><?php echo "Laravel ".$item->category_level; ?></label>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    ...
                                                    <?php if ($item->category_level == 1): ?>
                                                        <li>
                                                            <a href="<?php echo admin_url(); ?>form-settings/<?php echo html_escape($item->id); ?>"><i class="fa fa-cogs option-icon"></i>Form Setting</a>
                                                        </li>
                                                    <?php endif;?>
                                                    <li>
