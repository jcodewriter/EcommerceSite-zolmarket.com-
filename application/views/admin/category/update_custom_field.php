                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="field_type">
                                <option value="text" <?php echo $field->field_type == "text" ? "selected":"";?>><?php echo trans('text'); ?></option>
                                <option value="textarea" <?php echo $field->field_type == "textarea" ? "selected":"";?>><?php echo trans('textarea'); ?></option>
                                <option value="number" <?php echo $field->field_type == "number" ? "selected":"";?>><?php echo trans('number'); ?></option>
                                <option value="checkbox" <?php echo $field->field_type == "checkbox" ? "selected":"";?>><?php echo trans('checkbox'); ?></option>
                                <option value="radio_button" <?php echo $field->field_type == "radio_button" ? "selected":"";?>><?php echo trans('radio_button'); ?></option>
                                <option value="dropdown" <?php echo $field->field_type == "dropdown" ? "selected":"";?>><?php echo trans('dropdown'); ?></option>
                                <option value="popup" <?php echo $field->field_type == "popup" ? "selected":"";?>><?php echo trans('popup'); ?></option>
                                <option value="date" <?php echo $field->field_type == "date" ? "selected":"";?>><?php echo trans('date'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
