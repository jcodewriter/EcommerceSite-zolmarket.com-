            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div id="mobile_listcategories" class="mobile_selectdiv">
                        <button class="filter-btn text-truncate has-menu d-flex mobile-popup__button" type="button" data-ajax="0" data-type="mobilecat" data-url="admin_categories">
                            ...
                            <span class="flex-fill text-truncate text-left special-cagetory"><?php echo trans('select_category'); ?></span>
