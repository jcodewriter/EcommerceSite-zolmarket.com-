                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($item->is_default): ?>
                                        <i  data-country="<?=$item->id?>" class="fa fa-toggle-on" style="cursor: pointer;" onclick="set_country_default(this)"></i>
                                    <?php else: ?>
                                        <i data-country="<?=$item->id?>" class="fa fa-toggle-off" style="cursor: pointer;" onclick="set_country_default(this)"></i>
                                    <?php endif; ?>
                                </td>
                                <td width="20%">
                                    <div class="dropdown">
