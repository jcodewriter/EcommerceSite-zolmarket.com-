                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($item->is_default): ?>
                                        <i  data-id="<?=$item->state_id?>" data-city="<?=$item->id?>" class="fa fa-toggle-on" style="cursor: pointer;" onclick="set_city_default(this)"></i>
                                    <?php else: ?>
                                        <i  data-id="<?=$item->state_id?>" data-city="<?=$item->id?>" class="fa fa-toggle-off" style="cursor: pointer;" onclick="set_city_default(this)"></i>
                                    <?php endif; ?>
                                </td>
                                <td width="20%">
                                    <div class="dropdown">
