                ...
                <?php foreach ($languages as $key=>$language): ?>
                    <div class="form-group">
                        ...
                        <?php if($key):
                            ...
                            ?>
                            <input type="text" class="form-control" name="<?php echo $language->short_form;?>_name" value="<?php echo $state->$col; ?>" placeholder="<?php echo trans("name"); ?>" maxlength="200" required>
                        <?php else:?>
