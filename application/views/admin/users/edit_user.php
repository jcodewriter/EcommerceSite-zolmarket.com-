        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12 col-profile">
                            <img src="<?php echo html_escape(get_user_avatar($user)); ?>" alt="avatar" id="img-show" class="thumbnail img-responsive img-update" style="max-width: 200px;">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-input"
                           name="firstname" placeholder="<?php echo trans('first_name'); ?>"
                           value="<?php echo html_escape($user->firstname); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
                    <label><?php echo trans('last_name'); ?></label>
                    <input type="text" class="form-control form-input"
                           name="lastname" placeholder="<?php echo trans('last_name'); ?>"
                           value="<?php echo html_escape($user->lastname); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
