	...
	<div class="col-lg-6 col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<label class="m-b-15" style="font-size: 16px">User Email</label>

				<div class="form-group">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<label><?php echo trans('user_email_option_product_added'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="user_send_email_new_product" value="1" id="user_email_option_product_added_1" class="square-purple" <?php echo ($general_settings->user_send_email_new_product == '1') ? 'checked' : ''; ?>>
							<label for="user_email_option_product_added_1" class="option-label"><?php echo trans('yes'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="user_send_email_new_product" value="0" id="user_email_option_product_added_2" class="square-purple" <?php echo ($general_settings->user_send_email_new_product == '0') ? 'checked' : ''; ?>>
							<label for="user_email_option_product_added_2" class="option-label"><?php echo trans('no'); ?></label>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<label><?php echo trans('email_option_store_added'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="email_option_store_added" value="1" id="email_option_store_added_1" class="square-purple" <?php echo ($general_settings->email_option_store_added == '1') ? 'checked' : ''; ?>>
							<label for="email_option_store_added_1" class="option-label"><?php echo trans('yes'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="email_option_store_added" value="0" id="email_option_store_added_2" class="square-purple" <?php echo ($general_settings->email_option_store_added == '0') ? 'checked' : ''; ?>>
							<label for="email_option_store_added_2" class="option-label"><?php echo trans('no'); ?></label>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<label><?php echo trans('send_review_email'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="send_review_email" value="1" id="send_review_email_1" class="square-purple" <?php echo ($general_settings->send_review_email == '1') ? 'checked' : ''; ?>>
							<label for="send_review_email_1" class="option-label"><?php echo trans('enable'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="send_review_email" value="0" id="send_review_email_2" class="square-purple" <?php echo ($general_settings->send_review_email == '0') ? 'checked' : ''; ?>>
							<label for="send_review_email_2" class="option-label"><?php echo trans('disable'); ?></label>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<label><?php echo trans('send_comment_email'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="send_comment_email" value="1" id="send_comment_email_1" class="square-purple" <?php echo ($general_settings->send_comment_email == '1') ? 'checked' : ''; ?>>
							<label for="send_comment_email_1" class="option-label"><?php echo trans('enable'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="send_comment_email" value="0" id="send_comment_email_2" class="square-purple" <?php echo ($general_settings->send_comment_email == '0') ? 'checked' : ''; ?>>
							<label for="send_comment_email_2" class="option-label"><?php echo trans('disable'); ?></label>
						</div>
					</div>
				</div>

				<label class="m-b-15" style="font-size: 16px">Admin Email</label>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="send_email_shop_opening_request" value="1" id="send_email_shop_opening_request_1" class="square-purple" <?php echo ($general_settings->send_email_shop_opening_request == '1') ? 'checked' : ''; ?>>
							<label for="send_email_shop_opening_request_1" class="option-label"><?php echo trans('yes'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="send_email_shop_opening_request" value="0" id="send_email_shop_opening_request_2" class="square-purple" <?php echo ($general_settings->send_email_shop_opening_request == '0') ? 'checked' : ''; ?>>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="send_email_bidding_system" value="1" id="send_email_bidding_system_1" class="square-purple" <?php echo ($general_settings->send_email_bidding_system == '1') ? 'checked' : ''; ?>>
							<label for="send_email_bidding_system_1" class="option-label"><?php echo trans('enable'); ?></label>
						</div>
						<div class="col-sm-3 col-xs-12 col-option">
							<input type="radio" name="send_email_bidding_system" value="0" id="send_email_bidding_system_2" class="square-purple" <?php echo ($general_settings->send_email_bidding_system == '0') ? 'checked' : ''; ?>>
