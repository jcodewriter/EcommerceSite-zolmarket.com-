                        ...
                        <div class="form-box-body-other">
                            <?php if (!empty($user->password)) : ?>
                                <div class="form-group">
                                    ...
                                    <input type="password" name="old_password" class="form-control form-input required" message="<?php echo trans('please_enter_old_password') ?>" placeholder="<?php echo trans("old_password"); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control form-input required" message="<?php echo trans('please_enter_password') ?>"  placeholder="<?php echo trans("password"); ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label"><?php echo trans("password_confirm"); ?></label>
                                <input type="password" name="password_confirm" class="form-control form-input required" message="<?php echo trans('please_confirm') ?>" placeholder="<?php echo trans("password_confirm"); ?>" required>
                            </div>
