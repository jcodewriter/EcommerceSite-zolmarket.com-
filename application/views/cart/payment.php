                            ...
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-closed">
                                    <?php if ($mds_payment_type == "membership" || $mds_payment_type == "promote") : ?>
                                        <a href="<?php echo lang_base_url() . "cart/payment-method"; ?>?payment_type=<?= $mds_payment_type; ?>">
                                            <h2 class="title">
                                                <?php if (!empty($cart_has_physical_product) && $mds_payment_type == "sale") {
                                                    echo '2.';
                                                } else {
                                        ...
                                        <a href="<?php echo lang_base_url() . "cart/payment-method"; ?>?payment_type=<?= $mds_payment_type; ?>" class="link-underlined"><?php echo trans("edit"); ?></a>
                                    <?php else : ?>
                                        <a href="<?php echo lang_base_url() . "cart/payment-method"; ?>">
                                            <h2 class=" title">
                                                <?php if (!empty($cart_has_physical_product) && $mds_payment_type == "sale") {
                                                    echo '2.';
                                                } else {
