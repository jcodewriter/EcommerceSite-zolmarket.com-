...
<div class="hkm_messages_navCatDownMobile">
	<div class="cat-header">
        ...
        <div class="mobile-header-title">
            <span  class="text-white textcat-header text-center"><?php echo trans("msg_order_completed"); ?></span>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-confirm">
                    ...
                    <h1 class="title page_title_hidden_on_mobile"><?php echo trans("msg_order_completed"); ?></h1>
