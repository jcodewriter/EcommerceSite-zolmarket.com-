            ...
            <!-- <div class="col-12"> -->
                ...
                <div class="notification-item <?php echo $data->is_see?'':'is-see';?>" key="<?php echo $data->id;?>">
                    <a href="<?php echo lang_base_url().'notifications/'.$data->id;?>" name="ads_link" view_link="<?php echo $data->notification_type;?>">
                        <div class="avatar-item" url="<?php echo lang_base_url().$data->slug;?>">
                            ...
                            <div class="notification-icon close_shop">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="store-slash" class="svg-inline--fa fa-store-slash fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="currentColor" d="M121.51,384V284.2a119.43,119.43,0,0,1-28,3.8,123.46,123.46,0,0,1-17.1-1.2,114.88,114.88,0,0,1-15.58-3.6V480c0,17.7,13.59,32,30.4,32H505.75L348.42,384Zm-28-128.09c25.1,0,47.29-10.72,64-27.24L24,120.05c-30.52,53.39-2.45,126.53,56.49,135A95.68,95.68,0,0,0,93.48,255.91ZM602.13,458.09,547.2,413.41V283.2a93.5,93.5,0,0,1-15.57,3.6,127.31,127.31,0,0,1-17.29,1.2,114.89,114.89,0,0,1-28-3.8v79.68L348.52,251.77a88.06,88.06,0,0,0,25.41,4.14c28.11,0,53-13,70.11-33.11,17.19,20.11,42.08,33.11,70.11,33.11a94.31,94.31,0,0,0,13-.91c59.66-8.41,88-82.8,56.06-136.4L521.55,15A30.1,30.1,0,0,0,495.81,0H112A30.11,30.11,0,0,0,86.27,15L76.88,30.78,43.19,3.38A14.68,14.68,0,0,0,21.86,6.19L3.2,31.45A16.58,16.58,0,0,0,5.87,53.91L564.81,508.63a14.69,14.69,0,0,0,21.33-2.82l18.66-25.26A16.58,16.58,0,0,0,602.13,458.09Z"></path></svg>
                            </div>
                            <?php endif;?>
                        </div>
                    ...
                    <div class="detail-item">
                        <div class="follow">
                            <button class="btn btn-outline-gray" onclick="unfollow(<?php echo $data->relation_user_id;?>)" style="display: flex;background-color:#fff!important;padding: .2rem .5rem !important;font-size: 12px;">
                                <i class="icon-user-minus"></i><?php echo trans('unfollow');?>
                            </button>
                        </div>
                        
                        <div class="ads-img">
                            <img src="<?php echo get_product_image($data->ads_id, 'image_small');?>" style="height: 30px !important;border-radius: 3px;">
                        </div>
                    </div>
                    <?php endif;?>
