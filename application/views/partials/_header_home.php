            ...
            <div class="row">
                <div class="col-12 p-0">
                    <div class="mobile-header">
                        <div class="mobile-header-item mobile-header-item-icon d-none">
                            <a href="javascript:void(0)" class="btn-open-mobile-nav"><i class="icon-menu"></i></a>
                        </div>
                        <div class="mobile-header-item mobile-header-item-logo  pl-2 pr-5">
                            <a href="<?php echo lang_base_url(); ?>" class="mobile-logo"><img src="<?php echo get_logo($general_settings); ?>" alt="logo"></a>
                        </div>
                        <div class="mobile-header-item mobile-header-item-logo text-center mt-2">

                            <?php if ($this->auth_check): ?>
                                <div  class="cart-icon-mobile d-inline-block mr-3 text-center">
