    ...
    <div class="nav-mobile-inner">
        <ul class="navbar-nav">
            <?php if (is_multi_vendor_active()) :
                ...
                <?php else : ?>
                    <li class="nav-item item-sell-button m-b-15"><a href="<?php echo lang_base_url() . 'login'; ?>" class="btn btn-md btn-custom btn-block close-mobile-nav"><?php echo trans("sell_now"); ?></a></li>
            <?php endif;
            endif; ?>
            <li class="nav-item">
            ...
            <?php if ($this->auth_check) : ?>
                <li class="nav-item dropdown item-profile">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <?php endif; ?>
                        <a class="dropdown-item" href="<?php echo lang_base_url(); ?>account/<?php echo $this->auth_user->slug; ?>"><i class="icon-user"></i><?php echo trans("view_profile"); ?></a>
            ...
            <?php else : ?>
                <li class="nav-item"><a href="<?php echo lang_base_url() . 'login'; ?>" class="nav-link close-mobile-nav"><?php echo trans("login"); ?></a></li>
