...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, shrink-to-fit=yes, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0">
...
<?php endif; endforeach; endif; ?>    <!-- Icons -->
    ...
    <div class="mobile-menu">
        <div class="container-fluid">
            <div class="mobile-header">
                <div class="header-cell header-cell-nav d-none">
                    <a href="javascript:void(0)" class="btn-open-mobile-nav"><i class="icon-menu"></i></a>
                </div>
                <div class="header-cell header-cell-logo   pl-2 pr-5">
                ...
                <div class="header-cell header-cell-sell-now">
                    <?php if (is_marketplace_active()): ?>
                        <div class="cart-icon-mobile">
                            <a href="<?php echo lang_base_url(); ?>cart" class="cart-link-mobile"><i class="icon-cart"></i>
                                <?php $cart_product_count = get_cart_product_count();
                                if ($cart_product_count > 0): ?>
                                    <span class="notification"><?php echo $cart_product_count; ?></span>
                                <?php endif; ?>
                    ...
                    <div class="btn-sell-now-mobile-container">
                        <?php if (is_multi_vendor_active()):
                            if ($this->auth_check): ?>
                                <a href="<?php echo lang_base_url(); ?>sell-now" class="btn btn-sm btn-custom btn-sell-now-mobile"><?php echo trans("sell_now"); ?></a>
                            <?php else: ?>
                                <a href="javascript:void(0)" class="btn btn-md btn-custom btn-sell-now-mobile" data-toggle="modal" data-target="#loginModal"><?php echo trans("sell_now"); ?></a>
                            <?php endif;
                        endif; ?>
                    </div>
                </div>
