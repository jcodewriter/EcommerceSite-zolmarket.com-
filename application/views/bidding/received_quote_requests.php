...
<div class="hkm_messages_navCatDownMobile">
	<div class="cat-header">
        <div class="mobile-header-back">
			<a href="<?php echo $back_url;?>" class="btn-back-mobile-nav"> <i class="icon-arrow-left"></i> <?php echo trans("back"); ?>  </a>
        </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<h1 class="page-title page_title_hidden_on_mobile"><?php echo $title; ?></h1>
			</div>
		</div>

		<div class="row">
			<div class="col-12">
				<?php $this->load->view("bidding/_bidding_tabs"); ?>
			</div>
		</div>
		<?php if (!$this->is_mobile || !$is_show):?>
		<div class="row">
			<div class="col-sm-12">
