...
<div class="hkm_messages_navCatDownMobile">
	<div class="cat-header">
        ...
        <div class="mobile-header-title">
            <span  class="text-white textcat-header text-center"><?php echo trans("blog"); ?></span>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="blog-content">
                    ...
                    <h1 class="page-title page-title-product page_title_hidden_on_mobile"><?php echo trans("blog"); ?></h1>
