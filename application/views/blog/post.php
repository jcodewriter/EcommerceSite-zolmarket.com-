...
<div class="hkm_messages_navCatDownMobile">
	<div class="cat-header">
        ...
        <div class="mobile-header-title">
            <span  class="text-white textcat-header text-center"><?php echo html_escape($post->title); ?></span>
        </div>
                        ...
                        <div class="col-sm-12 col-md-9">
                            <div class="post-content">
                                <div class="row-custom">
                                    <h1 class="title page_title_hidden_on_mobile"><?php echo html_escape($post->title); ?></h1>
                                </div>
                                <div class="row-custom">
