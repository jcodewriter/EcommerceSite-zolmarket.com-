        ...
        if (!empty($custom_field)) :
            ...
            <?php if ($custom_field->field_type == "text") : ?>
                <div class="col-12 <?php echo ($custom_field->row_width == "half") ? "col-sm-6" : "col-sm-12"; ?> col-custom-field custom-field-type-<?php echo $category->category_level; ?>">
                    ...
                    <input type="text" name="field_<?php echo $custom_field->id; ?>" class="form-control form-input" value="<?php echo html_escape($custom_field->field_value); ?>" placeholder="<?php echo html_escape($custom_field->name); ?>" <?php echo ($custom_field->is_required == 1) ? 'required' : ''; ?>>
                </div>
            <?php elseif ($custom_field->field_type == "number") : ?>
                <div class="col-12 <?php echo ($custom_field->row_width == "half") ? "col-sm-6" : "col-sm-12"; ?> col-custom-field custom-field-type-<?php echo $category->category_level; ?>">
                    <label class="control-label"><?php echo html_escape($custom_field->name); ?></label>
                    <input type="number" name="field_<?php echo $custom_field->id; ?>" class="form-control form-input" value="<?php echo html_escape($custom_field->field_value); ?>" placeholder="<?php echo html_escape($custom_field->name); ?>" min="0" max="999999999" <?php echo ($custom_field->is_required == 1) ? 'required' : ''; ?>>
                </div>
            <?php elseif ($custom_field->field_type == "textarea") : ?>
                <div class="col-12 <?php echo ($custom_field->row_width == "half") ? "col-sm-6" : "col-sm-12"; ?> col-custom-field custom-field-type-<?php echo $category->category_level; ?>">
                    <label class="control-label"><?php echo html_escape($custom_field->name); ?></label>
                    <textarea class="form-control form-input custom-field-input" name="field_<?php echo $custom_field->id; ?>" placeholder="<?php echo html_escape($custom_field->name); ?>" <?php echo ($custom_field->is_required == 1) ? 'required' : ''; ?>><?php echo html_escape($custom_field->field_value); ?></textarea>
                </div>
            ...
            <?php elseif ($custom_field->field_type == "popup") : ?>
                ...
                <div class="col-12 <?php echo ($custom_field->row_width == "half") ? "col-sm-6" : "col-sm-12"; ?> col-custom-field custom-field-type-<?php echo $category->category_level; ?>">
                    ...
                    <div class="mobile_selectdiv">
                        <button class="filter-btn text-truncate has-menu d-flex mobile-popup__button" type="button" data-ajax="0" data-type="<?php echo $custom_field->product_filter_key; ?>" data-query="lang_id=<?php echo $this->selected_lang->id; ?> and field_id=<?php echo $custom_field->id; ?>&select" data-url="mobile_filter">
                                ...
                                <div class="col-12 col-sm-3">
                                    <div class="custom-control custom-radio custom-control-validate-input label_validate_field_<?php echo $custom_field->id; ?>">
                                        <?php if (is_value_in_array($option->common_id, $field_common_ids_array)) : ?>
                                            <input type="radio" class="custom-control-input" id="form_radio_<?php echo $option->id; ?>" name="field_<?php echo $custom_field->id; ?>" value="<?php echo html_escape($option->common_id); ?>" <?php echo ($custom_field->is_required == 1) ? 'required' : ''; ?> checked>
                                        <?php else : ?>
                                            <input type="radio" class="custom-control-input" id="form_radio_<?php echo $option->id; ?>" name="field_<?php echo $custom_field->id; ?>" value="<?php echo html_escape($option->common_id); ?>" <?php echo ($custom_field->is_required == 1) ? 'required' : ''; ?> <?php echo (empty($field_common_ids_array) && $count == 0 && $custom_field->is_required == 1) ? 'checked' : ''; ?>>
                                        <?php endif; ?>
                            ...
                            foreach ($common_options as $option) :
                                ...
                                <div class="col-12 col-sm-3">
                                    <div class="custom-control custom-checkbox custom-control-validate-input label_validate_field_<?php echo $custom_field->id; ?>">
                                        <?php if (is_value_in_array($option->common_id, $field_common_ids_array)) : ?>
                                            <input type="checkbox" class="custom-control-input" id="form_checkbox_<?php echo $option->id; ?>" name="field_<?php echo $custom_field->id; ?>[]" value="<?php echo html_escape($option->common_id); ?>" <?php echo ($custom_field->is_required == 1) ? 'required' : ''; ?> checked>
                                        <?php else : ?>
                                            <input type="checkbox" class="custom-control-input" id="form_checkbox_<?php echo $option->id; ?>" name="field_<?php echo $custom_field->id; ?>[]" value="<?php echo html_escape($option->common_id); ?>" <?php echo ($custom_field->is_required == 1) ? 'required' : ''; ?>>
                                        <?php endif; ?>
