...
<div class="hkm_messages_navCatDownMobile">
	<div class="cat-header">
        <div class="mobile-header-back">
            ...
            <?php else:?>
                <a href="<?php echo generate_category_url($parent_category); ?>" class="btn-back-mobile-nav ads_preview_btn"> <i class="icon-arrow-left"></i> <?php echo trans("back"); ?>  </a>
            <?php endif;?>    
        </div>
		...
		<div class="row">
			<div id="content" class="col-12">
                <div class="nav-mobile-inner">
                    <?php if($this->session->userdata('mds_category_link_session')):?>
...
<script>
    $(document).ready(function(){
        // window.history.pushState({},'', `<?php echo generate_category_url($category);?>`);
    })
</script>
