													...
													<div class="form-group">
														...
														<div id="mobile_listcategories" class="mobile_selectdiv">
															<?php if ($general_settings->default_product_location == 0): ?>
																<label class="control-label"><?php echo trans('country'); ?></label>
																<button class="filter-btn text-truncate has-menu d-flex m-b-15" type="button" name="country" data-ajax="0" data-type="country_id" data-url="country_location" style="height:50px;padding: 0 10px 0 10px" >
															<?php endif; ?>
																<?php if ($general_settings->default_product_location == 0): ?>
