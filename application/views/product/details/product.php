...
<div class="top-search-bar mobile-search-form cat-header" style="padding: 5px !important;">
	...
	<div class="right " style="padding-right: 20px;">
		<input type="text"  oninput="this.form.search.value = this.value" form="formsearchzolmarket"
			autocomplete="off" maxlength="300" data-url="menu_search"  data-query=""
			pattern=".*\S+.*" data-window="SearchWindowFilter" class="form-control input-search w-100 has-search-product"
			value="<?php echo (!empty($filter_search)) ? $filter_search : ''; ?>"
			placeholder="<?php echo html_escape($placeholder); ?>"  style="padding-top:10px">
						...
						<?php if($page != "product"): ?>
							<?php foreach ($categories as $category): ?>
								<?php if ($category->id != $endcat->id): ?>
									<li class="breadcrumb-item"><a
											href="<?php echo generate_category_url($category); ?>">
										...
										<div class="product-reviews">
											...
											<ul class="nav nav-tabs" id="review-comment">
												<?php if ($general_settings->product_reviews == 1): ?>
													<li class="nav-item">
														<a class="nav-link review-nav-link active" data-toggle="tab"
														   href="#reviews"><?php echo trans("reviews"); ?></a>
													</li>
												<?php endif; ?>
												<?php if ($general_settings->product_comments == 1): ?>
													<li class="nav-item">
														<a class="nav-link comment-nav-link <?php echo ($general_settings->product_reviews != 1) ? 'active' : ''; ?>"
