												...
												<div class="hidden-row">
													...
													<div id="mobile_listcategories" class="mobile_selectdiv">
														<button class="filter-btn text-truncate has-menu d-flex" type="button" data-ajax="0" data-type="mobilecat" data-url="special_categories" style="height:50px;padding: 0 10px 0 10px" >
															...
															<span class="titre  m-0 flex-fill  h-100 text-truncate  text-left special-cagetory" style="padding-left:5px"><?php echo trans('select_category'); ?></span>
	...
	$(document).ready(function(){
		if ($(this).width() < 500) {
			$("form").submit(function(e){
				if(!$('#category_id').val()){
					$('.filter-btn').css({'border-width':'1px', 'border-color': 'rgba(220, 53, 69, 0.40)'})
					e.preventDefault();
				}
			})
		}
