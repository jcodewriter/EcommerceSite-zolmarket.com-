									...
									<div class="form-box">
										...
										<div class="form-box-body">
											<div class="form-group" >
												...
												<input type="text" style="height:50px;;" name="title" class="form-control form-input required" message="<?php echo trans('please_enter_title')?>" placeholder="<?php echo trans("title"); ?>" required>
											</div>
