										...
										<div class="form-box-body">
											...
											<div class="form-group">
																...
																<select class="form-control" style="margin-top: 15px;" onchange="get_subcategories(this,<?=$key+1?>)"
																	...
																	foreach ($subcats as $item): ?>
																		<option
																			...
																			<?php echo  (isset($product_categories[$key+1])   && $item->id == $product_categories[$key+1]->id) ? 'selected' : ''; ?>>
												...
												<div id="mobile_listcategories" class="mobile_selectdiv">
													<button class="filter-btn text-truncate has-menu d-flex" type="button" data-ajax="0" data-type="mobilecat" data-url="special_categories" style="height:50px;padding: 0 10px 0 10px" >
														...
														<span class="titre  m-0 flex-fill  h-100 text-truncate  text-left special-cagetory" style="padding-left:5px"><?php $categories = end($product_categories); echo html_escape($categories->name); ?></span>
									...
									<div class="ajax-filter-menu">
										<div class="navCatDownMobile nav-mobile" id="filter1" style="margin-left: 105%;">
											<div class="form-group cat-header">
												...
												class="text-white textcat-header text-center"><?= trans('filter') ?></a>
											</div>
